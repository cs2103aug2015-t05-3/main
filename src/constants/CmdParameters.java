...
public class CmdParameters {
	...
	public static final String PARAM_VALUE_TASK_PRIORITY_VERYHIGH = "tpvh";
	public static final String PARAM_VALUE_TASK_PRIORITY_HIGH = "tph";
	public static final String PARAM_VALUE_TASK_PRIORITY_ABOVENORM = "tpan";
	public static final String PARAM_VALUE_TASK_PRIORITY_NORM = "tpn";
	public static final String PARAM_VALUE_TASK_PRIORITY_BELOWNORM = "tpbn";
